...
public class ShowAttendance extends javax.swing.JFrame {
    ...
    public void showData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                e.setShiftid(rs.getString("SHIFTID"));
                e.setShiftname(rs.getString("SHIFTNAME"));
                e.setShifttiming(rs.getString("SHIFTTIMING"));
        ...
        while (i < v.Counter()) {
            ...
            String employee[] = {e.getId(), e.getName(), e.getDepartmentID(), e.getDepartmentname(), e.getDesignation(),e.getShiftid(),e.getShiftname(),e.getShifttiming(),e.getStatus(),e.getDate()};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NAME", "DEPARMENT ID", "DEPARTMENT NAME", "DESIGNATION", "SHIFT ID", "SHIIFT NAME", "SHIFT TIMING", "STATUS", "DATE"
            }
        ) {
